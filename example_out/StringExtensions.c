...
const BSG_AnyType BSG_Type__StringExtensions = 0l;
...
struct BSG_Class__StringExtensions BSG_ClassSingleton__StringExtensions_StringExtensions = {
	.intToString = &BSG_Method__StringExtensions_intToString,
	.opaqueToString = &BSG_Method__StringExtensions_opaqueToString,
};
